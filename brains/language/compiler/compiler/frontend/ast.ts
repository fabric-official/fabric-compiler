// compiler/frontend/ast.ts
// AST node definitions for Fabric DSL
...
export type TypeExpr =
    | { kind: "Identifier"; name: string; size?: number }
...
export interface AgentNode extends Node {
    ...
    explain?: string[];
    device?: string;
    fallback?: { impl: string; state: string };
    policy?: PolicyNode;
}
...
export interface AtomPolicy {
    ...
    // collapse?: boolean; // not defined/used, keep it out unless reinstated
}
