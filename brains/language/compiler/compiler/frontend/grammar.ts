...
function peg$parse(input, options) {
  ...
  var peg$c3 = "agent";
  var peg$c4 = "policy";
  var peg$c5 = "coordination";
  var peg$c6 = "entangle";
  var peg$c7 = ":";
  var peg$c8 = "[";
  var peg$c9 = "]";
  var peg$c10 = "channel";
  var peg$c11 = "collapse";
  var peg$c12 = "on";
  var peg$c13 = ",";
  ...
  var peg$e3 = peg$literalExpectation("agent", false);
  var peg$e4 = peg$literalExpectation("policy", false);
  var peg$e5 = peg$literalExpectation("coordination", false);
  var peg$e6 = peg$literalExpectation("entangle", false);
  var peg$e7 = peg$literalExpectation(":", false);
  var peg$e8 = peg$literalExpectation("[", false);
  var peg$e9 = peg$literalExpectation("]", false);
  var peg$e10 = peg$literalExpectation("channel", false);
  var peg$e11 = peg$literalExpectation("collapse", false);
  ...
  function peg$parseStatement() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parsePolicyDecl();
        if (s0 === peg$FAILED) {
          s0 = peg$parseCoordinationDecl();
        }
      }
    }
  ...
  function peg$parseCoordinationDecl() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          s4 = peg$parse__();
          if (s4 !== peg$FAILED) {
            s5 = peg$parseCoordinationEntryList();
            if (s5 !== peg$FAILED) {
              s6 = peg$parse__();
              if (s6 !== peg$FAILED) {
                if (input.charCodeAt(peg$currPos) === 125) {
  ...
  function peg$parseCoordinationEntryList() {
    var s0, s1, s2, s3, s4, s5;

    s0 = peg$currPos;
    s1 = peg$parseCoordinationEntry();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse_();
      s5 = peg$parseCoordinationEntry();
      if (s5 !== peg$FAILED) {
        s4 = [s4, s5];
        s3 = s4;
      } else {
  ...
  function peg$parseCoordinationEntry() {
    var s0;

    s0 = peg$parseEntangleEntry();
    if (s0 === peg$FAILED) {
      s0 = peg$parseChannelEntry();
      if (s0 === peg$FAILED) {
        s0 = peg$parseCollapseEntry();
      }
    }
  ...
  function peg$parseEntangleEntry() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;
  ...
  function peg$parseChannelEntry() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseCollapseEntry() {
    var s0, s1, s2, s3, s4, s5, s6, s7;
